LANGS  = apacheconf asm asteriskael asteriskconf awk c cmake coffeescript \
         ...
         pkg-config pkgbuild po privoxy properties python rpmspec ruby sed \
...
build/ALL.nanorc: $(FILES) $(MIXINS) | build/theme.sed
	@echo '# This is autogenerated file for syntax coloring in Nano.' > $@
	@echo '# Do not edit this file by hand, your changes might' >> $@
	@echo '# be overwritten next time this file is re-generated.' >> $@
	@echo '# Instead, download yourself a copy of coloring files' >> $@
	@echo '# from https://github.com/YSakhno/nanorc.git, change those' >> $@
	@echo '# files, and run autogeneration of this file in there' >> $@
	@cat $(FILES) | $(FILTER) >> $@
	@echo 'Generated: $@'

build/%.nanorc: %.nanorc $(MIXINS) | build/theme.sed
	@echo '# This file was automatically generated from $< by nanorc (https://github.com/YSakhno/nanorc.git)' > $@
	@cat $< | $(FILTER) >> $@
	@echo 'Generated: $@'
